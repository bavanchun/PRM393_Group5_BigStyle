...
- Google Sign-In + OTP cần cấu hình dashboard (Supabase + Google Cloud) — xem checklist trong `../plans/260703-1226-auth-otp-google-fix/` (plan dir đã dời về `plans/` ở gốc repo).
