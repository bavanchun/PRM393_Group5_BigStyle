...
class AdminBloc extends Bloc<AdminEvent, AdminState> {
  ...
  Future<void> _onLoadDashboard(
    AdminLoadDashboard event, Emitter<AdminState> emit) async {
  ...
  Future<void> _onLoadUsers(
    AdminLoadUsers event, Emitter<AdminState> emit) async {
    emit(state.copyWith(isLoading: true, error: null));
    try {
  ...
  Future<void> _onUpdateBrandName(
    AdminUpdateBrandName event, Emitter<AdminState> emit) async {
    try {
  ...
  Future<void> _onAddUser(
    AdminAddUser event, Emitter<AdminState> emit) async {
    emit(state.copyWith(isLoading: true, error: null));
    try {
      ...
      emit(state.copyWith(
        isLoading: false,
        users: users,
        successMessage: 'Tạo người dùng thành công! Email invite đã được gửi.',
      ));
    } catch (e) {
      emit(state.copyWith(
        isLoading: false,
        error: 'Lỗi tạo người dùng: $e',
      ));
    }
  }

  Future<void> _onLoadCategories(
    AdminLoadCategories event, Emitter<AdminState> emit) async {
    emit(state.copyWith(isLoading: true, error: null));
    try {
  ...
  Future<void> _onCreateCategory(
    AdminCreateCategory event, Emitter<AdminState> emit) async {
    try {
  ...
  Future<void> _onUpdateCategory(
    AdminUpdateCategory event, Emitter<AdminState> emit) async {
    try {
  ...
  Future<void> _onDeleteCategory(
    AdminDeleteCategory event, Emitter<AdminState> emit) async {
    try {
